#ifndef INCLUDED_SIGNAL_DSBSC_HPP
#define INCLUDED_SIGNAL_DSBSC_HPP
...
class Signal_DSBSC : public Signal_Base
{
  private:
    int d_seed;
    float d_mod_idx;
  ...
  public:
    Signal_DSBSC(float mod_idx, size_t components, float* mu, float* sigma, float* weight, float samp_rate, size_t tap_count, int seed,
...
#endif /* INCLUDED_SIGNAL_DSBSC_HPP */
