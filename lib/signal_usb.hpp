#ifndef INCLUDED_SIGNAL_USB_HPP
#define INCLUDED_SIGNAL_USB_HPP
...
/*    void gen_gaussian(signal_threaded_buffer<float>* buffer, float var);
  ...
  public:
    Signal_USB(float mod_idx, float f_max, float var1, float var2, float thresh, int seed,
